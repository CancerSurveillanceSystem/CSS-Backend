...
public class RadiotherapyService {
    ...
    public Radiotherapy updateRadiotherapy(AddRadiotherapyRequest addRadiotherapyRequest, Long radiotherapyId){
        Optional<Radiotherapy> optionalRadiotherapy = radiotherapyRepository.findById(radiotherapyId);
        if (optionalRadiotherapy.isPresent()) {
            Radiotherapy radiotherapy = optionalRadiotherapy.get();
            radiotherapy = addRadiotherapyRequest.mapToRadiotherapy(radDetailsService, hospitalService, doctorService, userService, radiotherapy);
            radiotherapyRepository.save(radiotherapy);
            return radiotherapy;
        }
        return null;
