...
public class AddRadiotherapyRequest {
    ...
    public Radiotherapy mapToRadiotherapy(RadDetailsService radDetailsService, HospitalService hospitalService, DoctorService doctorService, UserService userService, Radiotherapy radiotherapy) {
        RadDetails radDetails = radDetailsService.findRadDetails(radRxType);
        if(radDetails != null){
            radiotherapy.setRadRxType(radDetails);
        }
