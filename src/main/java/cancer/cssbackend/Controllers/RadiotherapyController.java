...
public class RadiotherapyController {
    ...
    @PostMapping("/update/{radiotherapyId}")
    public Radiotherapy updateRadiotherapy(@RequestBody AddRadiotherapyRequest addRadiotherapyRequest, @PathVariable Long radiotherapyId) {
        return radiotherapyService.updateRadiotherapy(addRadiotherapyRequest, radiotherapyId);
    }
