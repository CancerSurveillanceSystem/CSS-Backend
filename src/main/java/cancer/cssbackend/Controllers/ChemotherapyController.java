...
public class ChemotherapyController {
    ...
    @PostMapping("/update/{chemotherapyId}")
    public Chemotherapy updateChemotherapy(@RequestBody AddChemotherapyRequest addChemotherapyRequest, @PathVariable Long  chemotherapyId) {
        return chemotherapyService.updateChemotherapy(addChemotherapyRequest, chemotherapyId);
    }
