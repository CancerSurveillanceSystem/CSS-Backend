...
public class SurgeryController {
    ...
    @PostMapping("/update/{surgeryId}")
    public Surgery updateSurgery(@RequestBody AddSurgeryRequest addSurgeryRequest, @PathVariable Long surgeryId) {
        return surgeryService.updateSurgery(addSurgeryRequest, surgeryId);
    }
