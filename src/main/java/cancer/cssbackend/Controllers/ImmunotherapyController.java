...
public class ImmunotherapyController {
    ...
    @PostMapping("/update/{immunotherapyId}")
    public Immunotherapy updateImmunotherapy(@RequestBody AddImmunotherapyRequest addImmunotherapyRequest, @PathVariable Long immunotherapyId) {
        return immunotherapyService.updateImmunotherapy(addImmunotherapyRequest, immunotherapyId);
    }
