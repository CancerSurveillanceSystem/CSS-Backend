...
CREATE TABLE HOSPITAL (
    ...
    HOSPITAL_ADDRESS INT,
    HOSPITAL_CONTACT_NO VARCHAR(15),
...
CREATE TABLE SPECIALTY (
    ...
    SPECIALTY_DESCRIPTION VARCHAR(1000),
...
CREATE TABLE USERTABLE (
    ...
    USER_ADDRESS INT, -- Foreign key to Address table
    USER_CONTACTNO VARCHAR(10),
    USER_ROLE INT, -- Foreign key to a Role table
    USER_ACCESS INT , -- Foreign key to an Access table
    USER_IS_VERIFIED CHAR(1),
    USER_STATUS VARCHAR(50),
    USER_CREATED_ON TIMESTAMP,
    USER_UPDATED_ON TIMESTAMP,
    USER_ENCODER INT, -- Foreign key to another User or another table
    CONSTRAINT PK_USER_ID PRIMARY KEY (USER_ID),
    CONSTRAINT FK_ADDRESS_USER FOREIGN KEY (USER_ADDRESS) REFERENCES Address(ADDRESS_ID),
    CONSTRAINT FK_ROLE_USER FOREIGN KEY (USER_ROLE) REFERENCES ROLETABLE(ROLE_ID),
...
CREATE TABLE FORGOT_PASSWORD (
    FORGOT_PASSWORD_ID INT NOT NULL,
    USER_ID INT,
    TOKEN VARCHAR(40),
    EXPIRY TIMESTAMP,
...
CREATE TABLE DOCTOR (
    ...
    DOCTOR_E_SIGNATURE BYTEA,
    DOCTOR_LICENSE_NUMBER VARCHAR(8) NOT NULL,
...
CREATE TABLE BODYSITE (
    BODYSITE_ID INT NOT NULL,
    BODYSITE_NAME VARCHAR(255),
...
CREATE TABLE HISTOLOGY (
    ...
    PATIENT_ID INT, -- Foreign key to PATIENT table
    HISTO_PATHOLOGY INT NOT NULL, -- Foreign key to a PATHOLOGY table
    HISTO_TUMOR_SIZE INT NOT NULL,
    HISTO_TUMOR_EXTENSION CHAR(1)  NOT NULL,
    HISTO_GRADE INT NOT NULL,
    HISTO_NODE_POSITIVE INT NOT NULL,
    HISTO_NODE_HARVEST INT NOT NULL,
    HISTO_MARGINS_NEGATIVE CHAR(1) NOT NULL,
    HISTO_POSITIVE_MARGINS VARCHAR(255) NOT NULL,
    HISTO_STAGE VARCHAR(50) NOT NULL,
    HISTO_CREATED_ON TIMESTAMP,
    HISTO_UPDATED_ON TIMESTAMP,
    HISTO_ENCODER INT, -- Foreign key to USER table or similar
...
CREATE TABLE DISEASE (
    ...
    PATIENT_ID INT, -- Foreign key to PATIENT table
    DISEASE_PRIMARY_SITE INT NOT NULL, -- Foreign key to BODYSITE table
    DISEASE_DIAGNOSIS_DATE DATE NOT NULL,
    DISEASE_BASIS INT NOT NULL, -- Foreign key to BASIS table
    DISEASE_LATERALITY VARCHAR(50) NOT NULL, -- Enum values should be managed by a check constraint or a separate lookup table
    DISEASE_HISTOLOGY INT, -- Foreign key to HISTOLOGY table
    DISEASE_EXTENT VARCHAR(50) NOT NULL, -- Enum values should be managed by a check constraint or a separate lookup table
    DISEASE_TUMOR_SIZE INT NOT NULL,
    DISEASE_LYMPH_NODE INT NOT NULL,
    DISEASE_METASTATIC CHAR(1) NOT NULL,
    DISEASE_METASTATIC_SITE INT, -- Foreign key to METASTATICSITE table
    DISEASE_MULTIPLE_PRIMARY INT NOT NULL,
    DISEASE_TSTAGE INT NOT NULL,
    DISEASE_NSTAGE INT NOT NULL,
    DISEASE_MSTAGE INT NOT NULL,
    DISEASE_GSTAGE INT,
    DISEASE_STAGE VARCHAR(50) NOT NULL,
    DISEASE_STAGE_TYPE VARCHAR(50) NOT NULL, -- Enum values should be managed by a check constraint or a separate lookup table
    DISEASE_STATUS INT NOT NULL, -- Foreign key to DISEASESTATUS table
    DISEASE_CREATED_ON TIMESTAMP,
    DISEASE_UPDATED_ON TIMESTAMP,
    DISEASE_ENCODER INT, -- Foreign key to USER table or similar
...
CREATE TABLE DISEASEOTHERSITE (
    DISEASEOTHERSITE_ID INT NOT NULL,
    DISEASE_ID INT NOT NULL,
    BODYSITE_ID INT NOT NULL,
...
CREATE TABLE RXTYPE (
    ...
    RXTYPE_NOTES VARCHAR(255),
    RXTYPE_ENCODER INT, -- Foreign key to USER table
...
CREATE TABLE SURGERY (
    ...
    PATIENT_ID INT, -- Foreign key to PATIENT table
    SURGERY_OPERATION VARCHAR(255) NOT NULL,
    SURGERY_DATE DATE NOT NULL,
    SURGERY_FINDINGS VARCHAR(255) NOT NULL,
    SURGERY_INTENT VARCHAR(255), -- Choices: Curative-complete, Curative-incomplete, Palliative only, Others
    SURGERY_SURGEON INT NOT NULL, -- Foreign key to DOCTOR table
    SURGERY_HOSPITAL INT NOT NULL, -- Foreign key to HOSPITAL table
    SURGERY_ENCODER INT, -- Foreign key to USER table
...
CREATE TABLE CHEMOPROTOCOL (
    CHEMOPROTOCOL_ID INT NOT NULL,
    CHEMODRUGS VARCHAR(255) NOT NULL,
    CHEMODOSAGE INT NOT NULL,
    CHEMONOCYCLE INT NOT NULL,
    CHEMODILUENT VARCHAR(255) NOT NULL,
...
CREATE TABLE TREATMENT (
    ...
    PATIENT_ID INT, -- Foreign key to PATIENT table
    TREATMENT_PRIMARYRXTYPE VARCHAR(255) NOT NULL, -- Field options: RxType field names
    TREATMENT_PRIMARYRXNAME VARCHAR(255) NOT NULL,
    TREATMENT_INITIALRXDATE DATE NOT NULL,
    TREATMENT_PURPOSE VARCHAR(255) NOT NULL, -- Field options: Curative-complete, Curative-incomplete, Palliative only, Others
    TREATMENT_PLAN INT NOT NULL, -- Foreign key to RXTYPE
    TREATMENT_ENCODER INT, -- Foreign key to USER table (logged-in user)
...
CREATE TABLE CHEMOTHERAPY (
    ...
    PATIENT_ID INT, -- Foreign key to PATIENT table
    CHEMO_TYPE VARCHAR(255) NOT NULL, -- Choices: neoadjuvant, adjuvant, palliative
    CHEMO_PROTOCOL INT NOT NULL, -- Foreign key to CHEMOPROTOCOL table
    CHEMO_INITIALDATE DATE NOT NULL,
    CHEMO_ENDDATE DATE,
    CHEMO_CYCLENUMBERGIVEN INT,
    CHEMO_STATUS VARCHAR(255) NOT NULL, -- Choices: ongoing, completed, not completed
    CHEMO_NOTES VARCHAR(255),
    CHEMO_ISCOMPLETED CHAR(1),
    CHEMO_FACILITY INT NOT NULL, -- Foreign key to HOSPITAL table
    CHEMO_DOCTOR INT NOT NULL, -- Foreign key to DOCTOR table
    CHEMO_ENCODER INT, -- Foreign key to USER table
...
CREATE TABLE IMMUNOTHERAPY (
    IMMUNORX_ID INT NOT NULL,
    PATIENT_ID INT, -- Foreign key to PATIENT table
    IMMUNORX_DRUG VARCHAR(255) NOT NULL,
    IMMUNORX_INITIALDATE DATE NOT NULL,
    IMMUNORX_ENDDATE DATE,
    IMMUNORX_STATUS VARCHAR(255) NOT NULL, -- Choices: ongoing, completed, not completed
    IMMUNORX_NOTES VARCHAR(255),
    IMMUNORX_ISCOMPLETED CHAR(1),
    IMMUNORX_FACILITY INT NOT NULL, -- Foreign key to HOSPITAL table
    IMMUNORX_DOCTOR INT NOT NULL, -- Foreign key to DOCTOR table
    IMMUNORX_ENCODER INT, -- Foreign key to USER table
...
CREATE TABLE HORMONAL (
    HORMONAL_ID INT NOT NULL,
    PATIENT_ID INT, -- Foreign key to PATIENT table
    HORMONAL_DRUG VARCHAR(255) NOT NULL,
    HORMONAL_DOSE INT NOT NULL,
    HORMONAL_INITIALDATE DATE NOT NULL,
    HORMONAL_ENDDATE DATE,
    HORMONAL_STATUS VARCHAR(255) NOT NULL, -- Choices: ongoing, completed, not completed
    HORMONAL_RX_NOTES VARCHAR(255),
    HORMONAL_DOCTOR INT NOT NULL, -- Foreign key to DOCTOR table
    HORMONAL_ENCODER INT, -- Foreign key to USER table
...
CREATE TABLE RAD_DETAILS (
    RADDETAILS_ID INT NOT NULL,
    RADDETAILS_PROCEDURE VARCHAR(255) NOT NULL,
    CONSTRAINT PK_RADDETAILS_ID PRIMARY KEY (RADDETAILS_ID)
);

CREATE TABLE RADIOTHERAPY (
    RADRX_ID INT NOT NULL,
    PATIENT_ID INT NOT NULL,
    RADRX_TYPE INT NOT NULL, -- Foreign key to RAD_DETAILS table
    RADRX_INITIALDATE DATE NOT NULL,
    RADRX_LASTDATE DATE,
    RADRX_DOSE INT NOT NULL,
    RADRX_BODYSITE VARCHAR(255) NOT NULL,
    RADRX_STATUS VARCHAR(255) NOT NULL, -- Choices: ongoing, completed, not completed
    RADRX_ISCOMPLETED CHAR(1) CHECK (RADRX_ISCOMPLETED IN ('Y', 'N')) NOT NULL,
    RADRX_FACILITY INT, -- Foreign key to HOSPITAL table
    RADRX_DOCTOR INT NOT NULL, -- Foreign key to DOCTOR table
    RADRX_ENCODER INT, -- Foreign key to USER table
...
CREATE TABLE CONSULT (
    ...
    PATIENT_ID INT, -- Foreign key to PATIENT table
    CONSULT_DATE DATE,
    CONSULT_SUBJECTIVE VARCHAR(255) NOT NULL,
    CONSULT_OBJECTIVE VARCHAR(255) NOT NULL,
    CONSULT_SURVWORKUP VARCHAR(255) NOT NULL,
    CONSULT_RXPLAN VARCHAR(255) NOT NULL,
    CONSULT_ASSESSMENT VARCHAR(255) NOT NULL,
    CONSULT_PATIENTSTATUS INT NOT NULL, -- Foreign key to DISEASE_STATUS table
...
CREATE TABLE NOTIFICATIONTYPE (
    NOTIFTYPE_ID INT PRIMARY KEY,
    NOTIFICATIONTYPE_NAME VARCHAR(200) NOT NULL
);
-- NOTIFICATIONSTATUS Table
CREATE TABLE NOTIFICATIONSTATUS (
    NOTIFSTATUS_ID INT PRIMARY KEY,
    NOTIFSTATUS_NAME VARCHAR(200) NOT NULL
);

CREATE TABLE NOTIFICATIONLOG (
     NOTIFLOG_ID INT PRIMARY KEY,
     NOTIFICATION_DATE DATE,
     NOTIFICATION_TYPE INT,
     NOTIFICATION_STATUS INT,
     NOTIFICATION_RECEIVER INT,
     NOTIFICATION_SENDER INT,
     NOTIFICATION_NOTES VARCHAR(2000),
...
CREATE TABLE SYMPTOMCATEGORY (
    SYMPTOMCATEGORY_ID INT PRIMARY KEY,
    SYMPTOM_CATEGORY VARCHAR(200) NOT NULL
);

CREATE TABLE SYMPTOMSURVEY (
    SYMPTOMSURVEY_ID INT PRIMARY KEY,
    CANCER_TYPE INT,
    SYMPTOM_NAME VARCHAR(200) NOT NULL,
    SYMPTOM_MEDICALTERM VARCHAR(200),
    SYMPTOM_CATEGORY INT,
    SYMPTOM_FILIPINO VARCHAR(100),
...
CREATE TABLE SURVEYRESPONSE (
    SURVEYRESPONSE_ID INT PRIMARY KEY,
    PATIENT_ID INT,
    DOCTOR_ID INT,
    SURVEYRESPONSE_DATE TIMESTAMP,
    RESPONSE_NOTE VARCHAR(254),
...
-- WORKUP Table
CREATE TABLE WORKUP (
    WORKUP_ID INT PRIMARY KEY,
    CANCER_TYPE INT,
    WORKUP_NAME VARCHAR(200) NOT NULL,
    WORKUP_FREQUENCY INT,
    WORKUP_TYPE VARCHAR(1000),
    WORKUP_INDICATION VARCHAR(1000),
    WORKUP_DURATION INT,
    WORKUP_REFERRAL VARCHAR(1000),
    CONSTRAINT FK_CANCER_TYPE_WORKUP FOREIGN KEY (CANCER_TYPE) REFERENCES BODYSITE(BODYSITE_ID)
);

-- LABSDOWNLOAD Table
CREATE TABLE LABSDOWNLOAD (
    LABREQ_ID INT PRIMARY KEY,
...
CREATE TABLE LABSUBMITTED (
    LABSUBMITTED_ID INT PRIMARY KEY,
    PATIENT_ID INT,
    DOCTOR_ID INT,
    LABSUBMISSION_DATE TIMESTAMP,
    WORKUP_NAME INT,
    LABFILELOCATION BYTEA,
    LABSUBMISSION_NOTES VARCHAR(2000),
    FOREIGN KEY (PATIENT_ID) REFERENCES PATIENT(PATIENT_ID),
    FOREIGN KEY (DOCTOR_ID) REFERENCES DOCTOR(DOCTOR_ID),
    FOREIGN KEY (WORKUP_NAME) REFERENCES WORKUP(WORKUP_ID)
);
...
CREATE TABLE LABMONITOR (
    LABMONITOR_ID INT PRIMARY KEY,
    LAB_SUBMITTED_ID INT,
    END_DATE DATE,
    STATUS VARCHAR(10),
...
CREATE TABLE CHECKUPSTATUS (
    CHECKUPSTATUS_ID INT PRIMARY KEY,
    NOTIFSTATUS_NAME VARCHAR(100) NOT NULL
);

-- CHECKUPSCHEDULE Table
CREATE TABLE CHECKUPSCHEDULE (
    CHECKUPSCHED_ID INT PRIMARY KEY,
    PATIENT_ID INT,
    DOCTOR_ID INT,
...
CREATE TABLE CHECKUP (
    ...
    CHECKUP_SUBJECTIVE VARCHAR(1000) NOT NULL,
    CHECKUP_OBJECTIVE VARCHAR(1000) NOT NULL,
    CHECKUP_ASSESSMENT VARCHAR(1000) NOT NULL,
    CHECKUP_PLAN VARCHAR(1000) NOT NULL,
    CHECKUP_SURVWORKUP VARCHAR(1000) NOT NULL,
    CHECKUP_PATIENTSTATUS INT,
    CHECKUP_SCHEDULE INT,
    FOREIGN KEY (PATIENT_ID) REFERENCES PATIENT(PATIENT_ID),
    FOREIGN KEY (DOCTOR_ID) REFERENCES DOCTOR(DOCTOR_ID),
